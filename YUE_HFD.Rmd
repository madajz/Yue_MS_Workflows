...
data = read.csv("~/bbc-secondary/research/MOOD_yue_MS_template_VBCS1110/MC00470_Merged_PoolSize_kidney_lipids (2606187b-313e-4b85-bf8a-eabb4f54cc05).csv",header=T)
...
data$ID = paste0("S",as.numeric(substr(data$ID,2,10)))
