...
ggplot(delta.delta.hfd,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(delta.delta.hfd[delta.delta.hfd$adj.P.Val<0.05,],row.names = F,digits = 4)
...
ggplot(hfd.df.m,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(hfd.df.m[hfd.df.m$adj.P.Val<0.05,],row.names = F,digits = 4)
...
ggplot(lfd.df.m,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(lfd.df.m[lfd.df.m$adj.P.Val<0.05,],row.names = F,digits = 4)
...
ggplot(detla.delta.df.m,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(detla.delta.df.m[detla.delta.df.m$adj.P.Val<0.05,],row.names = F,digits = 4)
...
ggplot(hfd.df.f,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(hfd.df.f[hfd.df.f$adj.P.Val<0.05,],row.names = F,digits = 4)
...
ggplot(ldf.df.f,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(ldf.df.f[ldf.df.f$adj.P.Val<0.05,],row.names = F,digits = 4)
...
ggplot(delta.delta.df,aes(x=logFC,y=-log10(P.Value),color=Significant)) + geom_point()+
...
knitr::kable(delta.delta.df[delta.delta.df$adj.P.Val<0.05,],row.names = F,digits = 4)
