...
file = "~/bbc-secondary/research/MOOD_yue_MS_template_VBCS1110/liver lipidomics/MC00331_liver_lipidomics.csv"
...
data.class$Sample = rownames(data.class)

data = left_join(data.class, subset(data,select=c(Geno,Sample,Sex)),by='Sample')

Molecule = colnames(data)[1:(which(colnames(data)=="Sample")-1)]
